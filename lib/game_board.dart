...
import 'package:my_chess/components/dead_piece.dart';
import 'package:my_chess/components/piece.dart';
import 'package:my_chess/components/square.dart';
import 'package:my_chess/helper/helper_methods.dart';
...
class _GameBoardState extends State<GameBoard> {
  ...
  // A list of value moves for the currently selected piece
  ...
  void pieceSelected(int row, int col) {
    setState(() {
      ...
      // if there is a piece selected and user tab on a square that is a valid move, move there
  ...
  List<List<int>> calculateRawValidMoves(int row, int col, ChessPiece? piece) {
    ...
    switch (piece.type) {
      case ChessPieceType.pawn:
        ...
        // pawns can move 2 squares forward if theu are at their initial positions
      ...
      case ChessPieceType.queen:
        // all eight directions: up, down, left, right, and 4 diagobals
        var directions = {
          [-1, 0], // up
          [1, 0], // down
          [0, -1], // left
  ...
  void _initializeBoard() {
    // initialize the board with nulls, meaning no piece in those positions
  ...
  bool isCheckMate(bool isWhiteKing) {
    ...
    // if there is at least one legal move for any type of the player's pieces, then it's not checkmate
    for (int i = 0; i < 8; i++) {
      for (int j = 0; j < 8; j++) {
